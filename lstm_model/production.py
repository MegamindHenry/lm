...
if __name__ == '__main__':
    ...
    parser.add_argument('-cw', action="store", dest="context_win",
        type=int, default=5, help='set context windows')
    parser.add_argument('-t', action="store", dest="target", type=str,
        default='tasaTest.txt', help='set target path')
    parser.add_argument('-mp', action="store", dest="model_path", type=str,
        default='../trained/demo_model.h5', help='set trained model path')
    parser.add_argument('-tp', action="store", dest="tokenizer_path",
        type=str, default='../trained/tokenizer.pkl',
        help='tokenizer save path')
    parser.add_argument('-tn', action="store", dest="top_num",
        type=int, default=100, help='top number of candidate to keep')
